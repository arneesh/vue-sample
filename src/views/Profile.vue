          ...
          <div class="px-4">
            ...
            <div class="text-center mt-5">
              ...
              <div class="h6 font-weight-300">
                <i class="ni location_pin mr-2"></i>City - Belgium
              </div>
              <div class="h6 mt-4">
                <i class="ni business_briefcase-24 mr-2"></i>Midfielder, False
                Nine, Playmaker
              </div>
              <div><i class="ni education_hat mr-2"></i>Manchester City FC</div>
            </div>
